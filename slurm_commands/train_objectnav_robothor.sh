...
#SBATCH --time=2-23:00
#SBATCH --job-name=objnav_robothor
...
set -x
srun python -u habitat-baselines/habitat_baselines/run.py --exp-config habitat-baselines/habitat_baselines/config/objectnav/ddppo_objectnav_robothor.yaml --run-type train
